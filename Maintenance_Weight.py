...
# Process: Near (3)
arcpy.Near_analysis(Sewer_SSO_STOP_shp, low_com_impact, "", "NO_LOCATION", "NO_ANGLE", "PLANAR")

# Process: Calculate Field (3)
arcpy.CalculateField_management(Sewer_SSO_STOP_shp, "To_Low_Pub", "!NEAR_DIST!", "PYTHON", "")

# Process: Near (3)
arcpy.Near_analysis(Sewer_SSO_STOP_shp, low_com_impact, "", "NO_LOCATION", "NO_ANGLE", "PLANAR")

# Process: Calculate Field (3)
arcpy.CalculateField_management(Sewer_SSO_STOP_shp, "To_Mod_Pub", "!NEAR_DIST!", "PYTHON", "")

# Process: Near (3)
arcpy.Near_analysis(Sewer_SSO_STOP_shp, low_com_impact, "", "NO_LOCATION", "NO_ANGLE", "PLANAR")

# Process: Calculate Field (3) # Getting an error that field doesn't exist 
arcpy.CalculateField_management(Sewer_SSO_STOP_shp, "To_High_Pu", "!NEAR_DIST!", "PYTHON", "")
...
#Create a Update Cursor to update the fields
sewers = arcpy.UpdateCursor(Sewer_SSO_STOP_shp)
